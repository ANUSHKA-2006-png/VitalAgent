...
DATA_DIR = PROJECT_ROOT / "data" / "processed" / "fall" / "splits"
OUTPUT_DIR = PROJECT_ROOT / "data" / "processed" / "moment_embeddings" / "fall"
...
def main():
    print("=" * 60)
    print("VITALAGENT — GENERATING MOMENT FALL EMBEDDINGS")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("[OK] FALL EMBEDDINGS SAVED SUCCESSFULLY")
    print("=" * 60)
